...
```yaml title=".uploads.yml" frame="code"
comment:
  ...
  # Whether images link to a share page. On a PR comment that is the feed
  # item pager; otherwise the /f/ file page. Overrides the workspace setting.
  linkToFilePage: true
