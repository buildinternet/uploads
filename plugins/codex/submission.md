...
| --------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | --------- | ----------- | ------------------------------------------------------------------------------------------------------- |
| `list`, `gallery_get`, `gallery_find_by_reference`, `feed_get`, `get_metadata`, `find_files`, `list_metadata_keys`, `repo_link_status`, `usage`, `whoami` | true     | false     | false       | Fetch or compute only. No writes.                                                                       |
| `gallery_create`, `gallery_add`, `gallery_link`, `feed_create`, `set_metadata`                                                                            | false    | true      | false       | Create or update a public gallery, change feed, or public `/f/` metadata. Do not delete objects.        |
